...
1. What is React JS and what problems does it solve? Support your answer with concepts introduced in class and from your personal research on the web.
  React is a library used to more easily render items containing state to the dom, using a virtual dom.
1. Describe component state.
  Component state is information that triggers UI changes.
1. Describe props.
  Props are values we pass to children elements. They can be passed down, but not back up.
1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
  Side Effects effect things outside of themselves. For instance, we use useEffect to sync functions to renders of other items or changes in state.
